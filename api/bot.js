...
bot.on("callback_query", async (ctx) => {  
  ...
  if (ctx.callbackQuery.data === "more") {  
    extra = "Give a detailed explanation.";  
  }  
  
  if (ctx.callbackQuery.data === "short") {  
    extra = "Give a short answer.";  
  }  
  
  if (ctx.callbackQuery.data === "regen") {  
    extra = "Give a different answer.";  
  }  
